...
author: "Study group 8, Tianyi Zhang"
date: "`r Sys.Date()`"
output:
  html_document:
    theme: flatly
...
bike$week[(bike$month == "Jan")&(bike$week == 52)] = 5
```
...
joined_bike %>% 
  ...
  ungroup() %>% 
  # Calculate the differene between actual and expected
